...
# Case generation logic if files are uploaded
if uploaded_files:
    all_text = ""
    ...
    with st.spinner("Generating case study from uploaded content..."):
        try:
            ...
            edited = st.text_area("✏️ Edit Case Study (optional):", value=case, height=400)
            ...
            st.error(f"Failed to generate case study: {e}")
